...
PAPYRUS_GLASS_CLOTH("papyrus/glass/cloth", "p/g/c", -1, new Resource[]{PAPYRUS, GLASS, CLOTH}  ),
	
	/** The BRIC k_ ston e_ or e_ wood. */
	BRICK_STONE_ORE_WOOD("brick/stone/ore/wood", "b/s/o/w", -1, new Resource[]{BRICK, WOOD, ORE, STONE} );
	 ...
	 */
	public Resource[] getOptionalRes() { return difTypes; }
