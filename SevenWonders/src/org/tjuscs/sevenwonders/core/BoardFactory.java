...
public class BoardFactory {
	...
	public static Board[] makeAandBSideBoards(int num){
		...
		boardPile[0] = ( rndGen.nextInt(100) <= 50 ? BoardInfo.ALEXANDRIA_A.buildBoard(): BoardInfo.ALEXANDRIA_B.buildBoard() ) ;
		...
		boardPile[4] = ( rndGen.nextInt(100) <= 50 ? BoardInfo.HALICARNASSUS_A.buildBoard() : BoardInfo.HALICARNASSUS_B.buildBoard() );
